  ...
  return props.songs.length === 0 ? (
        ...
        <div className="playlist-table">
          <div className="song-header-container">
            <div style={{ width: 40 }} />
            <div style={{ width: 40 }} />
            <div className="song-title-header mt-3">
              <p>Title</p>
            </div>
            <div className="song-artist-header mt-3  hidden md:block">
              <p>Artist</p>
            </div>
            {props.removeDate ? null : (
              <div className="song-added-header ml-6 hidden md:block">
                <i className="fa fa-calendar-plus-o" aria-hidden="true" />
              </div>
            )}
            <div className="song-length-header hidden md:block">
