...
import {setView } from '../store/slices/uiSliceAdmin'
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          ...
          >
            <img
              src={meomeo}
              className="h-20 w-20 rounded-full contain"
              alt="Flowbite Logo"
            />
          ...
          <ul className="space-y-2 font-medium">
            <li onClick={() => handleChangeView("dev")}>
              <a
                href="#"
            ...
            <li onClick={() =>handleChangeView("track")}>
              <a
                href="#"
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Bài hát</span>
                <span className="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">
                  +99
                </span>
              </a>
            </li>
            <li onClick={() =>handleChangeView("album")}>
              <a
                href="#"
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
            ...
            <li onClick={() =>handleChangeView("playlist")}>
              <a
                href="#"
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Danh sách bài hát</span>
              </a>
            </li>
            <li onClick={() =>handleChangeView("user")}>
              <a
                href="#"
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
            ...
            <li onClick={handleLogout}>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Đăng xuất ({user !== null? user.username:""})</span>
              </a>
            </li>
          </ul>
        </div>
